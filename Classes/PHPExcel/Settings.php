...
class PHPExcel_Settings
{
    ...
    private static array $_chartRenderers = [self::CHART_RENDERER_JPGRAPH];

    private static array $_pdfRenderers = [self::PDF_RENDERER_TCPDF, self::PDF_RENDERER_DOMPDF, self::PDF_RENDERER_MPDF];
     ...
     *		ZipArchive
     */
    private static string $_zipClass    = self::ZIPARCHIVE;
