...
class PHPExcel_IOFactory
{
  ...
  * @static
  */
 private static array $_searchLocations = [['type' => 'IWriter', 'path' => 'PHPExcel/Writer/{0}.php', 'class' => 'PHPExcel_Writer_{0}'], ['type' => 'IReader', 'path' => 'PHPExcel/Reader/{0}.php', 'class' => 'PHPExcel_Reader_{0}']];
  ...
  * @static
  */
 private static array $_autoResolveClasses = ['Excel2007', 'Excel5', 'Excel2003XML', 'OOCalc', 'SYLK', 'Gnumeric', 'HTML', 'CSV'];
 ...
 public static function createWriter(PHPExcel $phpExcel, $writerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				$className = str_replace('{0}', $writerType, (string) $searchLocation['class']);
	...
	public static function createReader($readerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				$className = str_replace('{0}', $readerType, (string) $searchLocation['class']);
