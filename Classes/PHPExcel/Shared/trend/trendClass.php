...
class trendClass
{
	 ...
	 * @var string[]
	 **/
	private static array $_trendTypes = [self::TREND_LINEAR, self::TREND_LOGARITHMIC, self::TREND_EXPONENTIAL, self::TREND_POWER];
	/**
	 * Names of the best-fit trend polynomial orders
	 *
	 * @var string[]
	 **/
	private static array $_trendTypePolyOrders = [self::TREND_POLYNOMIAL_2, self::TREND_POLYNOMIAL_3, self::TREND_POLYNOMIAL_4, self::TREND_POLYNOMIAL_5, self::TREND_POLYNOMIAL_6];
	 ...
	 **/
	private static array $_trendCache = [];
