...
class PHPExcel_Shared_String
{
	 ...
	 * @var string[]
	 */
	private static array $_controlCharacters = [];
  ...
  */
 private static ?bool $_isMbstringEnabled = null;

	/**
  * Is iconv extension avalable?
  */
 private static ?bool $_isIconvEnabled = null;
	...
	public static function IsUTF8($value = '') {
		return mb_convert_encoding(mb_convert_encoding($value, 'ISO-8859-1'), 'UTF-8', 'ISO-8859-1') === $value;
	}
