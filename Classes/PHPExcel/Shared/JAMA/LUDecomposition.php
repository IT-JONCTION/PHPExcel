...
class PHPExcel_Shared_JAMA_LUDecomposition {
	...
	final public const MatrixSingularException	= "Can only perform operation on singular matrix.";
	final public const MatrixSquareException		= "Mismatched Row dimension";
