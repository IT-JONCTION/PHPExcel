...
class PHPExcel_Shared_JAMA_Matrix {
	...
	final public const PolymorphicArgumentException	= "Invalid argument pattern for polymorphic function.";
	final public const ArgumentTypeException			= "Invalid argument type.";
	final public const ArgumentBoundsException		= "Invalid argument range.";
	final public const MatrixDimensionException		= "Matrix dimensions are not equal.";
	final public const ArrayLengthException			= "Array length must be a multiple of m.";
	 ...
	 *	@return mixed Element (int/float/double)
	 */
	public function set($i = null, $j = null, mixed $c = null) {
	 ...
	 */
	public function diagonal($m = null, $n = null, mixed $c = 1) {
		$R = new PHPExcel_Shared_JAMA_Matrix($m, $n);
		for($i = 0; $i < $m; ++$i) {
			$R->set($i, $i, $c);
		}
